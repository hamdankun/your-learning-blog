            ...
            <div class="section">
                <div class="row">
                    <form class="col s12 m5 right article-filter">
                      <div class="row">
                        <div class="input-field col s8 m8 full-right">
...
@section('scripts')
    ...
    <script src="{{ config('your.dist_path') }}/js/materialize-pagination.min.js"></script>
    <script src="{{ config('your.dist_path') }}/js/jquery.autocomplete.min.js"></script>
     <script src="{{ config('your.dist_path') . mix('/js/article-factory.js') }}"></script>
     <script src="{{ config('your.dist_path') . mix('/js/article-frontend.js') }}"></script>
@endsection