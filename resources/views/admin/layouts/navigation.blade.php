    ...
    <ul class="nav navbar-top-links navbar-right">
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu dropdown-user">
                ...
                <li class="divider"></li>
                <li><a href="javascript:void(0)" class="do-logout"><i class="fa fa-sign-out fa-fw"></i> Logout</a>
                <form action="{{ route('admin.login.logout') }}" method="POST" class="form-logout" hidden>
                    {{ csrf_field() }}
                </form>
                </li>
            </ul>
