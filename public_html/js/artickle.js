...
function renderImages(images) {
    ...
    $.each(_imgGallery, function (key, images) {
        ...
        $.each(images, function (key, val) {
            _imgGalleryContent += '<div class="col-sm-2 col-xs-6 img-gallery">' + '<img src="/storage/your-images/gallery/' + val.filename + '" alt="Article Image" class="img-responsive">' + '</div>';
        });
        _imgGallery += '</div>';
    });
