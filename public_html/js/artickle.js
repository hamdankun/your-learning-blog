...
_Dom.onClick('.add-keyword', function () {
    ...
    _formKeyword.removeClass('base-form-keyword').addClass('form-keyword').attr('data-type', 'form-keyword').hide().find('.control-label').html('keyword ' + ($('.form-keyword').length + 2));
    _formKeyword.find('.btn-area').children('button').removeClass('btn-primary').addClass('btn-danger').addClass('remove keyword').removeClass('add-keyword').children('i').removeClass('fa-plus-circle').addClass('fa-trash');
...
_Dom.onClick('.add-meta', function () {
    ...
    _formMeta.removeClass('base-form-meta').addClass('form-meta').attr('data-type', 'form-keyword');
    _formMeta.find('input[type=hidden].meta').remove();
    _formMeta.find('label').removeClass('control-label').html('<select class="form-control" name="seo[type][]"><option>Awesome</option></select>');
...
_Dom.onClick('.add-property', function () {
    ...
    _formProperty.removeClass('base-form-property').addClass('form-property').attr('data-type', 'form-property');
    _formProperty.find('input[type=hidden].property').remove();
    _formProperty.find('label').removeClass('control-label').html('<select class="form-control" name="seo[type][]"><option>Property</option></select>');
...
function changeBtnAddToRemove(elm, modify) {
    elm.children('button').removeClass('btn-primary').addClass('btn-danger').removeClass(modify['remove']).addClass(modify['add']).children('i').removeClass('fa-plus-circle').addClass('fa-trash');
    return elm.parent();
}
